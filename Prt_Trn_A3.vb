...
Public Class Prt_Trn_A3
    ...
    Private Sub CmdExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmdExcel.Click
        ...
        xlWorkSheet.Cells(1, 3).Value = "ค่าแรงหัก"
        xlWorkSheet.Cells(1, 4).Value = "ค่าแรงรับ"
        xlWorkSheet.Cells(1, 5).Value = "ค่าแรงคงเหลือ"


        Dim SqlString As String
        SqlString = "SELECT Dep_Id,Dep_Th,Sal_Credit,Sal_Debit,(Sal_Debit-Sal_Credit) as Total " & _
        " FROM TmpTran2"
