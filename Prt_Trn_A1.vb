...
Public Class Prt_Trn_A1
    ...
    Private Sub MakeTable1()
        ...
        With ComSave
            .CommandText = "Prc_Trn_A1"
            .Parameters.Clear()
            .Parameters.Add("@StrDate", SqlDbType.VarChar)
            .Parameters("@StrDate").Value = DateTimePicker1.Text
            .Parameters.Add("@EndDate", SqlDbType.VarChar)
            .Parameters("@EndDate").Value = DateTimePicker2.Text
            .Parameters.Add("@XEmpSt_Id", SqlDbType.VarChar)

            'If Not (MEmpStId = "01" Or MEmpStId = "02" Or MEmpStId = "03") Then
            '.Parameters("@XEmpSt_Id").Value = "%"
            'Else
            '.Parameters("@XEmpSt_Id").Value = MEmpStId
            'End If
